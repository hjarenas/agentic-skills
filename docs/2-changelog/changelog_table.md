...
- **v1.6.0 (Orchestrator Bounded Wait — Week 2, 20-08-2026)**:
  ...
  - **Merge-slot recovery**: the stuck serialized merge slot can be released, but only against a four-part observable git-state test (no in-progress merge, neither rebase form, no cherry-pick, clean worktree)
