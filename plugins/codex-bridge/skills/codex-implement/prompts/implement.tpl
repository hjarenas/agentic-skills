...
1. `docs/archi/index.md` — architecture single source of truth. Read the index, then follow the
   links to the pages covering the area you are changing. If `docs/archi/` does not exist, read
   `docs/ARCHI.md` instead.
...
- Implement exactly what the plan says — nothing more. The instruction block below usually
  ...
  in a later turn.
- Follow the existing codebase patterns documented in the architecture wiki (module boundaries,
  error handling, naming). Apply DRY and KISS.
