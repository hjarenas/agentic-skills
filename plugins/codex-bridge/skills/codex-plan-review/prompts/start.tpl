...
Read the project's architecture memory, then review the planning document at `{{TARGET}}`.

Architecture memory lives at `docs/archi/index.md` — read the index, then follow the links to
the pages that cover the area this plan touches. Do not read every page. If `docs/archi/` does
not exist, the project has not migrated yet: read `docs/ARCHI.md` in full instead.
